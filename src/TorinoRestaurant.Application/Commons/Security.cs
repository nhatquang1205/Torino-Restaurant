...
using TorinoRestaurant.Application.Commons.Schemas;
...
namespace TorinoRestaurant.Application.Commons
{
    ...
    public class Security
    {
        ...
        public static string GenerateJWTCode(JwtData data)
        {
            ...
            var configuration = StartupState.Instance.Configuration.GetSection("TokenKey");
            // Khởi tạo Claim
        ...
        {
            SortedList<String, String> paramValues = new(new ParamsCompare());
